...
public void history(){
   ...
   try
   {
      rs =stmt.executeQuery("select * from hi"+ImMemNo+";");
   ...
   public void returnBook(String value){
      ...
      try{
         String sql = "update rent set memNo=null, rentdate= null, rentable='대여가능' where no ='"+rbookNo+"';";
   ...
   public void saveH(String id, String no, String name, String writer, String publisher){
      try{
         String sql = "insert into hi"+ImMemNo+" values('"+no+"', '"+name+"', '"+writer+"', '"+publisher+"');";
         stmt.executeUpdate(sql);
