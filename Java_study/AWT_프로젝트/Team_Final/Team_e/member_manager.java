...
class member_manager extends JFrame implements ActionListener
{
	...
	String cols[]={"memNo","이름","ID","Email","성별","대여여부","대여한 책"};
	...
	public class MyMouse extends MouseAdapter{
		public void mousePressed(MouseEvent me){
			...
			value=(String)model.getValueAt(row, 2);
		...
		try
		{
			...
			while(rs.next())
			{
				...
				String bname="";
					...
					bookR=0;
					if(!rs2.next()){
						System.out.println("else  bookR : "+memNo+"번째 회원 "+0);
					...
					System.out.println("if bookR : "+memNo+"번째 회원 "+bookR);
	...
	public void actionPerformed(ActionEvent e){
		...
		if(e.getSource()==b2) //삭제.
		{
			...
			try{
				...
				//창제목, 메세지, 버튼.
				if(table.getValueAt(table.getSelectedRow(),5)!=0){
                    ...
                    return;
      				...
      				case JOptionPane.YES_OPTION :
      					...
      					{
      						stmt.executeUpdate("delete from member where id='"+value+"'");
