...
function openConfirmID(formID){
	...
	url="confirmId.do?id="+formID.id.value;
...
<!-- 	<form method="post" name="userForm" action="inputPro.jsp">
	../member/loginPro.do -->
	<form method="post" name="userForm" onsubmit="return checkIt()" action="../member/inputPro.do">
	...
	<td width="400">
		...
		<input type="button"  value="가입 안함" onclick="window.location='../member/main.do'">
