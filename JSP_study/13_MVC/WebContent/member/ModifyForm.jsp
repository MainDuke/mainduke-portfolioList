...
<body bgcolor="<%=bodyback_c%>">
	<form method="post" name="userForm" action="../member/modifyPro.do" onsubmit="return checkIt()">
	...
	<table width="600" border="1" cellpadding="3" cellspacing="0" align="center">
		...
		<input type="button" value="취소"  onclick="document.location.href='../member/main.do'">
		</td>
		</tr>
