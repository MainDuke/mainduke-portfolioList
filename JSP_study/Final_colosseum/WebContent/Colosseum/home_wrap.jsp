...
<span id="menu1" data-color="#ABE4F3" class="menu_button"  style="background-color: #ABE4F3;"> 
...
<span id="menu8" data-color="#DBEFF5" class="menu_button"  style="background-color: #DBEFF5;"> 
