...
<jsp:useBean id="mgr" class="boardoracle.BoardMgr"/><%-- 객체생성 --%>
...
//System.out.println("num 테스트 입니다. : "+request.getParameter("num"));
//System.out.println("pwd 테스트 입니다. : "+request.getParameter("pwd"));

BoardBean bean=mgr.getBoard(num);//메서드 호출      
//System.out.println("bean.num 테스트 입니다. : "+bean.getNum());
//System.out.println("bean.pass 테스트 입니다. : "+bean.getPass());
